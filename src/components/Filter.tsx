...
function Filter({ product }: { product: Product[] }) {
  ...
  return (
    <div className="lg:border-[1px] rounded-2xl lg:p-6 h-full">
      <div className="flex justify-between items-center font-satoshi">
        <h1 className="text-2xl font-semibold max-lg:hidden">Filter</h1>
                ...
                <DrawerHeader>
                  <DrawerTitle>
                    <div className="flex justify-between items-center border-b-[1px] py-2">
                      <h1>Filter</h1>
                      <DrawerClose>
                        <Button variant="ghost" className="hover:rounded-full">
                          <svg
                            width="15"
                            height="15"
                            viewBox="0 0 16 17"
                  ...
                  <DrawerDescription>
                    <div className="py-5">
                      <ul className="flex flex-col gap-1 items-start justify-center  text-lg font-satoshi text-[#666666] border-b-[1px] pb-4">
